...
#define KOMODO_NOTARIES_TIMESTAMP2 1575743400 // Saturday, December 7, 2019 6:30:00 PM GMT
#define KOMODO_NOTARIES_HEIGHT2 ((789070 / KOMODO_ELECTION_GAP) * KOMODO_ELECTION_GAP)
...
{
    static uint8_t elected_pubkeys0[64][33], elected_pubkeys1[64][33], elected_pubkeys2[64][33], did0, did1, did2; static int32_t n0,n1,n2;
