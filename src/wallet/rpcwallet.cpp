...
UniValue z_mergetoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 6)
        throw runtime_error(
            ...
            "                             - \"ANY_RADDR\":   Merge UTXOs from any Raddrs belonging to the wallet.\n"
            ...
            "    [\n"
            "      \"address\"          (string) Can be an Raddr or a zaddr\n"
            "      ,...\n"
            "    ]\n"
            "2. \"toaddress\"           (string, required) The Raddr or zaddr to send the funds to.\n"
            "3. fee                   (numeric, optional, default="
