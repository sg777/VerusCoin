...
unsigned char parse_hex(char c)
{
    ...
    if ('a' <= c && c <= 'f') return c - 'a' + 10;
    std::runtime_error("Parse Hex failed, non hex char");
    return 0;
}

std::vector<unsigned char> parse_string(const std::string & s)
{
    if (s.size() % 2 != 0) std::runtime_error("Parse string failed, string odd number for hex");
...
bool CETHPATRICIABranch::testProof(){
   ...
   // address = (parse_string("1148744c707a6bff512d4C6499A071dF2ff43538"));
    ...
    storageProof.proof_branch = {parse_string(""),
